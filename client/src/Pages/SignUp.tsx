        ...
        <>
          <div>
            ...
            <div className="m-10">
              ...
              <h4 className="text-4xl mt-7">
                Kindly note your account address!
              </h4>
              <h5 className="text-3xl mt-7">
                Your address: <span className="text-xl">{address}</span>
              </h5>
              <Link to="/signin">
                <button className="mt-7">Click Here to move to signin!!</button>
              </Link>
            </div>
          </div>
        </>
              ...
              >
                ...
                >
                  <TextField
                    ...
                    className="rounded-md  ml-6 w-full required mt-1 m-2 border border-blue-700   text-start"
                    onChange={(e: any) => {
                  ...
                  <TextField
                    ...
                    className="rounded-md  ml-6 required mb-2 w-full border border-blue-700   text-start"
                    onChange={(e: any) => {
